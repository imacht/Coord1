...
static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_client_rm_hyphen_sink = \
  SL_CLI_COMMAND(emberAfPluginGreenPowerClientAddSink,
                 "remove a sink for a given GPD.  If thats the last sink, remove the proxy table entry",
                  "GPD Source ID" SL_CLI_UNIT_SEPARATOR "Sinks IEEE address" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT32, SL_CLI_ARG_HEX, SL_CLI_ARG_END, });
...
static const sl_cli_command_info_t cli_cmd_mask_add = \
  SL_CLI_COMMAND(emberAfPluginNetworkCreatorChannelMaskCommand,
                 "Add a channel to the channel mask of choice.",
                  "The mask of choice to which to add the channel. Entering an argument of 1 will choose the primary channel mask. Any other argument will choose the secondary channel mask." SL_CLI_UNIT_SEPARATOR "The channel to add to the channel mask." SL_CLI_UNIT_SEPARATOR,
...
static const sl_cli_command_info_t cli_cmd_mask_subtract = \
  SL_CLI_COMMAND(emberAfPluginNetworkCreatorChannelMaskCommand,
                 "Subtract a channel from the channel mask of choice.",
                  "The mask of choice from which to subtract the channel. Entering an argument of 1 will choose the primary channel mask. Any other argument will choose the secondary channel mask." SL_CLI_UNIT_SEPARATOR "The channel to subtract from the channel mask." SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT32, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_mask_set = \
  SL_CLI_COMMAND(emberAfPluginNetworkCreatorChannelMaskCommand,
                 "Set a channel mask.",
                  "The mask of choice to set. Entering an argument of 1 will choose the primary channel mask. Any other argument will choose the secondary channel mask." SL_CLI_UNIT_SEPARATOR "The bit mask to which to set the chosen channel mask." SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT32, SL_CLI_ARG_END, });
...
static const sl_cli_command_info_t cli_cmd_network_hyphen_creator_hyphen_security_set_hyphen_joining_hyphen_link_hyphen_key = \
  SL_CLI_COMMAND(emAfPluginNetworkCreatorSecuritySetJoiningLinkKeyCommand,
                 "Set the link key that a specific joining device will use when joining the network. This command can be also used to add install code derived link keys. If all FFs are entered for the EUI64 for the joining device, then this link key will be used for all joining devices without a joining key entry.",
...
static const sl_cli_command_info_t cli_cmd_network_hyphen_creator_hyphen_security_set_hyphen_distributed_hyphen_key = \
  SL_CLI_COMMAND(emAfPluginNetworkCreatorSecurityConfigureDistributedKey,
                 "Set the TC Link key for a distributed network",
                  "The preconfigured distributed key that the joining device will use to enter the network." SL_CLI_UNIT_SEPARATOR,
...
static const sl_cli_command_info_t cli_cmd_network_hyphen_steering_pre_hyphen_configured_hyphen_key_hyphen_set = \
  SL_CLI_COMMAND(emberAfPluginNetworkSteeringSetPreconfiguredKeyCommand,
                 "Set the pre-configured key",
                  "Set the preconfigured key so that the joining device can enter the network." SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_HEX, SL_CLI_ARG_END, });
...
static const sl_cli_command_info_t cli_cmd_zll_hyphen_commissioning_endpoints = \
  SL_CLI_COMMAND(getEndpointListRequest,
                 "Send a GetEndpointListRequest to a server.",
                  "The network address of the device to which the request will be sent." SL_CLI_UNIT_SEPARATOR "The source endpoint from which the request will be sent." SL_CLI_UNIT_SEPARATOR "The destination endpoint to which the request will be sent." SL_CLI_UNIT_SEPARATOR "The endpoint index at which to start retreiving data." SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT16, SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });
